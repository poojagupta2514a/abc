...
There are many ways to contribute to abc.

  * Submit a feature request or bug, or add to the discussion on the [abc issue tracker][is]
  * Submit a [Pull Request][pr] to improve abc.
...
If you are new to abc development and you don't have push access to the abc
...
When submitting a PR, make sure to add a `Cc: @abc/developers` comment to
notify abc developers of your awesome contributions. Based on the
...
* You do NOT have push access: A abc core developer will integrate your PR.
...
[pr]: https://github.com/abc/abc/merge_requests
[is]: https://github.com/abc/abc/issues
